    ...
    def update(
        ...
        for _ in range(cfg.ppo_epochs):
            for mb in iter_minibatches(
                ...
                clipped_mask = ((ratio < clip_low) | (ratio > clip_high)).float()
                ...
                total_clip_frac += float(clipped_mask.mean().item())
                n_mb += 1
