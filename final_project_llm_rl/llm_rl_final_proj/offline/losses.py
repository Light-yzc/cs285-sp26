...
def compute_offline_preference_loss(
    *,
    ...
    if algo == "dpo":
        ...
        # losses = -torch.log(F.sigmoid(beta * logits)) 
        ...
        chosen_rewards, _ = (policy_scores.chosen_logp_mean - reference_scores.chosen_logp_mean).sort()
        rejected_rewards, _ = (policy_scores.rejected_logp_mean - reference_scores.rejected_logp_mean).sort()

        quantile_gap = chosen_rewards - rejected_rewards
        # losses = -torch.log(F.sigmoid(beta * quantile_gap))
